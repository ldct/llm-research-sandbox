...
TestCreativeInvariants := function(n, i)
    local G, elements, e, a, b, inv1, inv2, inv3, inv4, inv5, inv6, inv7, inv8, inv9, inv10, inv11, inv12, inv13, inv14, inv15;
